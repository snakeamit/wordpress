      ...
      <div class="row">
        <div class="col-md-12">
          <div class="box box-primary">
            <div class="box-header" align=center>
              ...
              <p class="box-title" style="font-size: 22px;"><b>Special Admin Page at IBR Live! </p>
            </div>
          </div>
        </div><!-- /.col -->        
        <!-- /.col -->               
        ...
        <div class="col-md-5">
		  ...
		  <th>Duration (Days)</th>				  
                ...
                $pname = "";
                while($row2 = $result2->fetch_assoc()){ 
                  echo "<tr><td>" . $row2['name'] . "</td><td>&#8377; " . $row2['price'] . "</td><td>" . $row2['duration'] . "</td></tr>"; 
        ...
        <div class="col-md-7">
          <div class="box" style="height: 340px; overflow-y: scroll;">
            <div class="box-header">
            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-hover">
                ...
                while($row2 = $result2->fetch_assoc()){ 
                  ...
                  . $row2['interest'] . "</td><td>" . $row2['phone'] . "</td></tr>"; 
                }
                ?>
              </table>
            </div>
        ...
        <div class="col-md-12">
          <div class="box" style="height: 400px; overflow-y: scroll;">
            <div class="box-header">
              <h3 class="box-title">Customers Purchase(s) (Only Successful Transactions)</h3>
            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-hover">
                ...
                while($row3 = $result3->fetch_assoc()){ 
                  //if($pname!="")
                  echo "<tr><td>" . $row3['order_id'] . "</td><td>&#8377; " . $row3['amount'] . "</td><td>" . $row3['customer_name'] . "</td><td>" . $row3['customer_email'] . "</td><td>" . $row3['customer_phone'] . "</td><td>" . $row3['products_name'] . "</td><td>" . date("d-m-Y", strtotime($row3['paid_on'])) . "</td><td>" . date("d-m-Y", strtotime($row3['expire_on'])) . "</td><td>" . $row3['sub_status'] . "</td></tr>"; 
                  //} 
                }              
        ...
        <div class="col-md-12">
          <div class="box" style="height: 400px; overflow-y: scroll;">
            <div class="box-header">
              <h3 class="box-title">All orders (Including Failed orders also)</h3>
        ...
        <div class="col-md-12">
          <div class="box" style="height: 400px; overflow-y: scroll;">
            <div class="box-header">
              <h3 class="box-title">User Login Information (Last 20 User Login)</h3>
            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-hover">
                ...
                //$custId= $_SESSION['sessCustomerID'];
                $query5 = "SELECT * from userlog WHERE userEmail != 'admin@ibrlive.com' and userEmail != 'test@ibrlive.com' ORDER By id DESC LIMIT 20"; 
