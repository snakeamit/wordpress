    ...
    <div class="col-md-12" style="margin-top: 10px;">
      ...
      <!-- /.box -->
          ...
          <div class="col-md-12" style="margin-top: 10px; background-color: #EBF5FB;">
            ...
            <p class="box-title" style="font-size: 22px; margin-bottom: 10px;"><i class="fa fa-newspaper-o  "></i> <b>Latest blogs </b></p>
            </div>
            ...
            <div class="col-md-4">
               ...
               <div class="panel" style="padding: 20px;">
                    <div class="panel-heading"><strong><h4>How understanding of USD to INR CASH, TOM, SPOT & FORWARD rates can benefit an Exporter or Importer?</h4></strong></div>
                    <div class="panel-body" style="font-size: 16px; color: black;">When it comes to USD to INR exchange, there are four types of exchange rates differentiated by settlement date. With an understanding of these rates, you can save a lot of money & hedge your currency exposure.</div>
                    <br/>
            ...
            <div style="box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
               <div class="panel" style="padding: 20px;">
                    <div class="panel-heading"><strong><h4>Currency Forward Contract</h4></strong></div>
                    <div class="panel-body" style="font-size: 16px; color: black;">What Is a Currency Forward Contract?
        A currency forward contract can be defined as buying or selling a specific currency at a specified future price for delivery on a specified future date.</div>
                    <br/>
                    <div style="padding-left: 20px;">
            ...
            <a href="https://ibrlive.com/blogs/powerful-strategies-booking-currency-forward-contract-for-exporters"> 
             ...
             <div style="box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
               <div class="panel" style="padding: 20px;">
                    <div class="panel-heading"><strong><h4>10 Powerful Strategies of Booking Currency Forward Contract For Exporters</h4></strong></div>
                    <div class="panel-body" style="font-size: 16px; color: black;">Booking a currency forward contract hedge your adverse currency movement risk, but by adopting the following strategies, you may earn good profits out of it.</div>
                    <br/>
                    <div style="padding-left: 20px;">
