  ...
  <div class="content-wrapper" style="background-color: white;">
    ...
    <section class="content">
          ...
          <div class="row">
            ...
            <div class="col-md-12">
              <div style="background-color: #EAF2F8;">
                <div class="box-header" align=center>
                  ...
                  <p class="box-title" style="font-size: 22px; padding: 5px;"><b>Welcome to IBRLive India Private Limited!</b></p>
            ...
            <div class="col-md-12 callout callout-info">    
              <h4>Notification!</h4>
               Now CASH and TOM values are available for EUR and GBP also. Please use drop down menu to watch the rates.
            </div>
            
            <div class="col-md-6 callout callout-info">    
              <h4>* Currency forecast!</h4>
               <h4>New feature! Daily, Weekly and monthly currency forecast is now available at <a href="currency-forecast">IBRLive &dash; Currency Forecast</a>!</h4>
            </div>
           -->
            
            <div class="col-md-12 callout callout-info">    
              <h4>New year celebration!</h4>
               <h4>If you are here for the Mock test series, please visit our new website: <a href="https://ibrlive.estudium.org" target="_blank">ibrlive.estudium.org</a>! Existing users can still use this current website.</h4>
            </div>
      ...
      <div class="item">
        <div class="row">
          <div class="col-xs-12">
            <div class="thumbnail adjust1">
              <div class="col-md-2 col-sm-2 col-xs-12">
                <img class="media-object img-rounded img-responsive" src="images/weavetex-logo.jpg">
              </div>
              <div class="col-md-10 col-sm-10 col-xs-12">
                <div class="caption">
                  ...
                  <blockquote class="adjust2">
                    <p>Abhishek Gupta, Weavetex Exports </p> <small><cite title="Weavetex Exports"><i class="glyphicon glyphicon-globe"></i> https://www.linkedin.com/company/weavetex-exports/about/</cite></small>
                  </blockquote>
                </div>
              </div>
            </div>
