...
<head>
  ...
  <![endif]-->
    ...
    <script>
    var prevVal=0,prevValEUR=0,prevValGBP=0,prevValAUD=0,prevValCAD=0,prevValNZD=0,prevValAED=0,prevValTHB=0,newVal=0,newValEUR=0,newValGBP=0,newValAUD=0,newValCAD=0,newValNZD=0,newValAED=0,newValTHB=0,rcvData=function(){"1"!=sessionStorage.getItem("infodone")&&sessionStorage.setItem("infodone","1");setInterval(function(){0},1e3);$("#coverScreen").hide(),$.post("get-live-rates",{data:"1"},function(e){ findTomSpotBidData('1'); findTomSpotAskData('1'); var t=e.split("-");if(usdToINRrate=0,"0"==t[1])document.getElementById("inrToUSD").innerHTML='<font style="font-size: 16px; color: #164f75;">Available Soon</font>';else{var o=parseFloat(t[2]).toFixed(4),n=parseFloat(t[3]).toFixed(4),a=0;a=(parseFloat(o)+parseFloat(n))/parseFloat(2),usdToINRrate=a,document.getElementById("inrToUSDbid").innerHTML='<font style="font-size: 20px; color: #164f75;">'+parseFloat(o).toFixed(4)+"</font>",document.getElementById("inrToUSDask").innerHTML='<font style="font-size: 20px; color: #164f75;">'+parseFloat(n).toFixed(4)+"</font>",document.getElementById("inrToUSD").innerHTML='<font style="font-size: 20px; color: #164f75;">'+parseFloat(a).toFixed(4)+"</font>",document.getElementById("frate-1").value=parseFloat(a).toFixed(4),0==prevVal?(newVal=parseFloat(a).toFixed(4),prevVal=parseFloat(a).toFixed(4)):parseFloat(a).toFixed(4)==prevVal?(newVal=parseFloat(a).toFixed(4),prevVal=parseFloat(a).toFixed(4)):(newVal=parseFloat(a).toFixed(4),prevVal=newVal,document.getElementById("inrToUSD").style.backgroundColor="#F2D7D5"),document.getElementById("inrToUSDhigh").innerHTML='<font style="font-size: 20px; color: #164f75;">'+parseFloat(t[4]).toFixed(4)+"</font>",document.getElementById("inrToUSDlow").innerHTML='<font style="font-size: 20px; color: #164f75;">'+parseFloat(t[5]).toFixed(4)+"</font>"}if("0"==t[11])document.getElementById("inrToEUR").innerHTML='<font style="font-size: 16px; color: #164f75;">Available Soon</font>';else{o=parseFloat(t[12]).toFixed(4),n=parseFloat(t[13]).toFixed(4),a=0;a=(parseFloat(o)+parseFloat(n))/parseFloat(2),document.getElementById("inrToEURbid").innerHTML='<font style="font-size: 20px; color: #164f75;">'+parseFloat(o).toFixed(4)+"</font>",document.getElementById("inrToEURask").innerHTML='<font style="font-size: 20px; color: #164f75;">'+parseFloat(n).toFixed(4)+"</font>",document.getElementById("inrToEUR").innerHTML='<font style="font-size: 20px; color: #164f75;">'+parseFloat(a).toFixed(4)+"</font>",document.getElementById("frate-2").value=parseFloat(a).toFixed(4),0==prevValEUR?(newValEUR=parseFloat(a).toFixed(4),prevValEUR=parseFloat(a).toFixed(4)):parseFloat(a).toFixed(4)==prevValEUR?(newValEUR=parseFloat(a).toFixed(4),prevValEUR=parseFloat(a).toFixed(4)):(newValEUR=parseFloat(a).toFixed(4),prevValEUR=newValEUR,document.getElementById("inrToEUR").style.backgroundColor="#EBDEF0"),document.getElementById("inrToEURhigh").innerHTML='<font style="font-size: 20px; color: #164f75;">'+parseFloat(t[14]).toFixed(4)+"</font>",document.getElementById("inrToEURlow").innerHTML='<font style="font-size: 20px; color: #164f75;">'+parseFloat(t[15]).toFixed(4)+"</font>"}if("0"==t[21])document.getElementById("inrToGBP").innerHTML='<font style="font-size: 16px; color: #164f75;">Available Soon</font>';else{o=parseFloat(t[22]).toFixed(4),n=parseFloat(t[23]).toFixed(4),a=0;a=(parseFloat(o)+parseFloat(n))/parseFloat(2),document.getElementById("inrToGBPbid").innerHTML='<font style="font-size: 20px; color: #164f75;">'+parseFloat(o).toFixed(4)+"</font>",document.getElementById("inrToGBPask").innerHTML='<font style="font-size: 20px; color: #164f75;">'+parseFloat(n).toFixed(4)+"</font>",document.getElementById("inrToGBP").innerHTML='<font style="font-size: 20px; color: #164f75;">'+parseFloat(a).toFixed(4)+"</font>",document.getElementById("frate-3").value=parseFloat(a).toFixed(4),0==prevValGBP?(newValGBP=parseFloat(a).toFixed(4),prevValGBP=parseFloat(a).toFixed(4)):parseFloat(a).toFixed(4)==prevValGBP?(newValGBP=parseFloat(a).toFixed(4),prevValGBP=parseFloat(a).toFixed(4)):(newValGBP=parseFloat(a).toFixed(4),prevValGBP=newValGBP,document.getElementById("inrToGBP").style.backgroundColor="#D4E6F1"),document.getElementById("inrToGBPhigh").innerHTML='<font style="font-size: 20px; color: #164f75;">'+parseFloat(t[24]).toFixed(4)+"</font>",document.getElementById("inrToGBPlow").innerHTML='<font style="font-size: 20px; color: #164f75;">'+parseFloat(t[25]).toFixed(4)+"</font>"}if("0"==t[31])document.getElementById("inrToAUD").innerHTML='<font style="font-size: 16px; color: #164f75;">Available Soon</font>';else{o=parseFloat(t[32]).toFixed(4),n=parseFloat(t[33]).toFixed(4),a=0;a=(parseFloat(o)+parseFloat(n))/parseFloat(2),document.getElementById("inrToAUDbid").innerHTML='<font style="font-size: 20px; color: #164f75;">'+parseFloat(o).toFixed(4)+"</font>",document.getElementById("inrToAUDask").innerHTML='<font style="font-size: 20px; color: #164f75;">'+parseFloat(n).toFixed(4)+"</font>",document.getElementById("inrToAUD").innerHTML='<font style="font-size: 20px; color: #164f75;">'+parseFloat(a).toFixed(4)+"</font>",0==prevValAUD?(newValAUD=parseFloat(a).toFixed(4),prevValAUD=parseFloat(a).toFixed(4)):parseFloat(a).toFixed(4)==prevValAUD?(newValAUD=parseFloat(a).toFixed(4),prevValAUD=parseFloat(a).toFixed(4)):(newValAUD=parseFloat(a).toFixed(4),prevValAUD=newValAUD,document.getElementById("inrToAUD").style.backgroundColor="#D1F2EB"),document.getElementById("inrToAUDhigh").innerHTML='<font style="font-size: 20px; color: #164f75;">'+parseFloat(t[34]).toFixed(4)+"</font>",document.getElementById("inrToAUDlow").innerHTML='<font style="font-size: 20px; color: #164f75;">'+parseFloat(t[35]).toFixed(4)+"</font>"}if("0"==t[41])document.getElementById("inrToCAD").innerHTML='<font style="font-size: 16px; color: #164f75;">Available Soon</font>';else{o=parseFloat(parseFloat(t[42]).toFixed(4)).toFixed(4),n=parseFloat(parseFloat(t[43]).toFixed(4)).toFixed(4),a=0;a=(parseFloat(o)+parseFloat(n))/parseFloat(2),document.getElementById("inrToCADbid").innerHTML='<font style="font-size: 20px; color: #164f75;">'+parseFloat(o).toFixed(4)+"</font>",document.getElementById("inrToCADask").innerHTML='<font style="font-size: 20px; color: #164f75;">'+parseFloat(n).toFixed(4)+"</font>",document.getElementById("inrToCAD").innerHTML='<font style="font-size: 20px; color: #164f75;">'+parseFloat(a).toFixed(4)+"</font>",0==prevValCAD?(newValCAD=parseFloat(a).toFixed(4),prevValCAD=parseFloat(a).toFixed(4)):parseFloat(a).toFixed(4)==prevValCAD?(newValCAD=parseFloat(a).toFixed(4),prevValCAD=parseFloat(a).toFixed(4)):(newValCAD=parseFloat(a).toFixed(4),prevValCAD=newValCAD,document.getElementById("inrToCAD").style.backgroundColor="#D4EFDF"),document.getElementById("inrToCADhigh").innerHTML='<font style="font-size: 20px; color: #164f75;">'+parseFloat(t[44]).toFixed(4)+"</font>",document.getElementById("inrToCADlow").innerHTML='<font style="font-size: 20px; color: #164f75;">'+parseFloat(t[45]).toFixed(4)+"</font>"}if("0"==t[51])document.getElementById("inrToNZD").innerHTML='<font style="font-size: 16px; color: #164f75;">Available Soon</font>';else{o=parseFloat(t[52]).toFixed(4),n=parseFloat(t[53]).toFixed(4),a=0;a=(parseFloat(o)+parseFloat(n))/parseFloat(2),document.getElementById("inrToNZDbid").innerHTML='<font style="font-size: 20px; color: #164f75;">'+parseFloat(o).toFixed(4)+"</font>",document.getElementById("inrToNZDask").innerHTML='<font style="font-size: 20px; color: #164f75;">'+parseFloat(n).toFixed(4)+"</font>",document.getElementById("inrToNZD").innerHTML='<font style="font-size: 20px; color: #164f75;">'+parseFloat(a).toFixed(4)+"</font>",0==prevValNZD?(newValNZD=parseFloat(a).toFixed(4),prevValNZD=parseFloat(a).toFixed(4)):parseFloat(a).toFixed(4)==prevValNZD?(newValNZD=parseFloat(a).toFixed(4),prevValNZD=parseFloat(a).toFixed(4)):(newValNZD=parseFloat(a).toFixed(4),prevValNZD=newValNZD,document.getElementById("inrToNZD").style.backgroundColor="#FCF3CF"),document.getElementById("inrToNZDhigh").innerHTML='<font style="font-size: 20px; color: #164f75;">'+parseFloat(t[54]).toFixed(4)+"</font>",document.getElementById("inrToNZDlow").innerHTML='<font style="font-size: 20px; color: #164f75;">'+parseFloat(t[55]).toFixed(4)+"</font>"}if("0"==t[61])document.getElementById("inrToTHB").innerHTML='<font style="font-size: 16px; color: #164f75;">Available Soon</font>';else{o=parseFloat(parseFloat(t[62]).toFixed(4)).toFixed(4),n=parseFloat(parseFloat(t[63]).toFixed(4)).toFixed(4),a=0;a=(parseFloat(o)+parseFloat(n))/parseFloat(2),document.getElementById("inrToTHBbid").innerHTML='<font style="font-size: 20px; color: #164f75;">'+parseFloat(o).toFixed(4)+"</font>",document.getElementById("inrToTHBask").innerHTML='<font style="font-size: 20px; color: #164f75;">'+parseFloat(n).toFixed(4)+"</font>",document.getElementById("inrToTHB").innerHTML='<font style="font-size: 20px; color: #164f75;">'+parseFloat(a).toFixed(4)+"</font>",0==prevValTHB?(newValTHB=parseFloat(a).toFixed(4),prevValTHB=parseFloat(a).toFixed(4)):parseFloat(a).toFixed(4)==prevValTHB?(newValTHB=parseFloat(a).toFixed(4),prevValTHB=parseFloat(a).toFixed(4)):(newValTHB=parseFloat(a).toFixed(4),prevValTHB=newValTHB,document.getElementById("inrToTHB").style.backgroundColor="#FAE5D3"),document.getElementById("inrToTHBhigh").innerHTML='<font style="font-size: 20px; color: #164f75;">'+parseFloat(t[64]).toFixed(4)+"</font>",document.getElementById("inrToTHBlow").innerHTML='<font style="font-size: 20px; color: #164f75;">'+parseFloat(t[65]).toFixed(4)+"</font>"}if("0"==t[71])document.getElementById("inrToAED").innerHTML='<font style="font-size: 16px; color: #164f75;">Available Soon</font>';else{o=parseFloat(parseFloat(t[72]).toFixed(4)).toFixed(4),n=parseFloat(parseFloat(t[73]).toFixed(4)).toFixed(4),a=0;a=(parseFloat(o)+parseFloat(n))/parseFloat(2),document.getElementById("inrToAEDbid").innerHTML='<font style="font-size: 20px; color: #164f75;">'+parseFloat(o).toFixed(4)+"</font>",document.getElementById("inrToAEDask").innerHTML='<font style="font-size: 20px; color: #164f75;">'+parseFloat(n).toFixed(4)+"</font>",document.getElementById("inrToAED").innerHTML='<font style="font-size: 20px; color: #164f75;">'+parseFloat(a).toFixed(4)+"</font>",0==prevValAED?(newValAED=parseFloat(a).toFixed(4),prevValAED=parseFloat(a).toFixed(4)):parseFloat(a).toFixed(4)==prevValAED?(newValAED=parseFloat(a).toFixed(4),prevValAED=parseFloat(a).toFixed(4)):(newValAED=parseFloat(a).toFixed(4),prevValAED=newValAED,document.getElementById("inrToAED").style.backgroundColor="#FAE5D3"),document.getElementById("inrToAEDhigh").innerHTML='<font style="font-size: 20px; color: #164f75;">'+parseFloat(t[74]).toFixed(4)+"</font>",document.getElementById("inrToAEDlow").innerHTML='<font style="font-size: 20px; color: #164f75;">'+parseFloat(t[75]).toFixed(4)+"</font>"}setTimeout(function(){document.getElementById("inrToUSD").style.backgroundColor="#f9f9f9",document.getElementById("inrToEUR").style.backgroundColor="white",document.getElementById("inrToGBP").style.backgroundColor="#f9f9f9",document.getElementById("inrToAUD").style.backgroundColor="white",document.getElementById("inrToCAD").style.backgroundColor="#f9f9f9",document.getElementById("inrToNZD").style.backgroundColor="white",document.getElementById("inrToAED").style.backgroundColor="#f9f9f9",document.getElementById("inrToTHB").style.backgroundColor="white"},1e4)}),$("#coverScreen").hide()};setInterval(function(){rcvData()},1e3);var f1=0;function CalculateGST(e,t,o){var n,a=e.unit_input.value,l=t.unit_input.value,r=0;isNaN(a)&&(a=a.replace(/[^0-9\.]/g,"")).split(".").length>2&&(a=a.replace(/\.+$/,"")),isNaN(l)&&(l=l.replace(/[^0-9\.]/g,"")).split(".").length>2&&(l=l.replace(/\.+$/,"")),n=parseFloat(a)*parseFloat(l),a<=0||l<=0?r=0:n<=1e5?n<=250?r=45:(r=.01*n*.18)<=45&&(r=45):r=n>1e5&&n<=1e6?.18*(1e3+.005*(n-1e5)):n<555e5?.18*(5500+.001*(n-1e6)):10800,e.unit_input.value=a,t.unit_input.value=l,o.unit_input.value=r.toFixed(2)}function CalculateUnit(e,t){var o=e.unit_input.value;isNaN(o)&&(o=o.replace(/[^0-9\.]/g,"")).split(".").length>2&&(o=o.replace(/\.+$/,""));var n=0;switch(t.unit_menu.value){case"INR":n=o;break;case"USD":n=1/parseFloat(document.getElementById("inrToUSD").getElementsByTagName("font")[0].innerHTML);break;case"EUR":n=1/parseFloat(document.getElementById("inrToEUR").getElementsByTagName("font")[0].innerHTML);break;case"GBP":n=1/parseFloat(document.getElementById("inrToGBP").getElementsByTagName("font")[0].innerHTML);break;case"AUD":n=1/parseFloat(document.getElementById("inrToAUD").getElementsByTagName("font")[0].innerHTML);break;case"CAD":n=1/parseFloat(document.getElementById("inrToCAD").getElementsByTagName("font")[0].innerHTML);break;case"NZD":n=1/parseFloat(document.getElementById("inrToNZD").getElementsByTagName("font")[0].innerHTML);break;case"THB":n=1/parseFloat(document.getElementById("inrToTHB").getElementsByTagName("font")[0].innerHTML);break;case"AED":n=1/parseFloat(document.getElementById("inrToAED").getElementsByTagName("font")[0].innerHTML)}isNaN(o)&&0!=o?t.unit_input.value="":(e.unit_input.value=o,"INR"==t.unit_menu.value?t.unit_input.value=o:t.unit_input.value=(o*n).toFixed(2))}function CalculateUnit2(e,t){var o=e.unit2_input.value;isNaN(o)&&(o=o.replace(/[^0-9\.]/g,"")).split(".").length>2&&(o=o.replace(/\.+$/,""));var n=0;switch(e.unit2_menu.value){case"INR":n=o;break;case"USD":n=parseFloat(document.getElementById("inrToUSD").getElementsByTagName("font")[0].innerHTML);break;case"EUR":n=parseFloat(document.getElementById("inrToEUR").getElementsByTagName("font")[0].innerHTML);break;case"GBP":n=parseFloat(document.getElementById("inrToGBP").getElementsByTagName("font")[0].innerHTML);break;case"AUD":n=parseFloat(document.getElementById("inrToAUD").getElementsByTagName("font")[0].innerHTML);break;case"CAD":n=parseFloat(document.getElementById("inrToCAD").getElementsByTagName("font")[0].innerHTML);break;case"NZD":n=parseFloat(document.getElementById("inrToNZD").getElementsByTagName("font")[0].innerHTML);break;case"THB":n=parseFloat(document.getElementById("inrToTHB").getElementsByTagName("font")[0].innerHTML);break;case"AED":n=parseFloat(document.getElementById("inrToAED").getElementsByTagName("font")[0].innerHTML)}isNaN(o)&&0!=o?t.unit2_input.value="":(e.unit2_input.value=o,"INR"==e.unit2_menu.value?t.unit2_input.value=o:t.unit2_input.value=(o*n).toFixed(2))}      
  ...
  <div class="content-wrapper" style="background-color: white;">
    ...
    <section class="content">
          <div class="row">
            ...
            <div class="col-md-12">
              <div class=""  style="background-color: #EAF2F8;">
            ...
            <!--<div class="col-md-12 callout callout-info">    
              <h4>Live Rates are paused for a moment!</h4>
              All other services except the live-rates are working. Thank you for your cooperation.
            </div>-->
                ...
                <div class="box-body pad table-responsive" id="no-more-tables">
                  ...
                  <table class="table table-bordered text-center table-bordered table-striped table-condensed cf">
                    ...
                    <tr>
                      ...
                      <th class="numeric"><h4><b>LIVE RATES (Mid Values) (&#8377;)</b></h4></th>
                    ...
                    <tr>
                      <td class="numeric"><h4><b><img src="images/flags/SGD.png" style="display: inline; width: 30px; height: auto;"/> 1 SGD (S&#36;)</b></h4></td>
...
Real Time Exchange rates (Mid Market Rates/Interbank Rates/Spot rates)- Mid Market rates are average of buy & sell transactional rates of a currency pair. <br/>These rates are just for reference purpose and not for transaction purpose.</h5>
    ...
    <div class="col-md-12" style="margin-top: 10px;">
        ...
        <div class="box-body" align=center>    
            ...
            <div class="col col-lg-4 text-center" style="padding: 1em; background: #000; ">
                <iframe width="280" src="https://www.youtube.com/embed/V-SFzmi2PN8" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
      ...
      ?>
            ...
            <div class="col-md-4 " style="margin-top: 10px;">
              <div class="" style="box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
                ...
                <div class="box-body" align=center>
                    <div class="converter-wrapper">
                        <h4><i class="fa fa-lock" aria-hidden="true"></i> Subscription is required to access this service.</h4>
                        <hr/>
                        <a href="our-products"><button style="margin-top: 5px;" class="btn btn-warning"><i class="fa fa-angle-double-right"></i> Buy FXPRESS now</button></a>
                    </div>
                </div>
                
                <div class="box-body pad table-responsive" id="no-more-tables2" style="display: none;">
                  
                  <table class="table table-bordered text-center table-bordered table-striped table-condensed cf" id="t-bid-ask">
                    <thead class="cf">
                    <tr>
                      <th class="numeric"><h4><b>Quote Currency</b></h4></th>
                      <th colspan="4" class="numeric"><img src="images/flags/INR.png" style="display: inline; width: 40px; height: auto;"/><h4 style="display:inline;"><b> INR (&#8377;)</b></h4></h4>
                    ...
                    <tr>
                      <td class="numeric"><h4><b><img src="images/flags/SGD.png" style="display: inline; width: 30px; height: auto;"/> 1 SGD (S&#36;)</b></h4></td>
                      <td data-title="BID (S&#36;)" id="inrToSGDbid"></td>
                      
                      <td data-title="ASK (S&#36;)" id="inrToSGDask"></td>
                    </tr>
                    <tbody> 
