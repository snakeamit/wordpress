...
function PasswordWidget(divid,pwdname)
{
	...
	this.showing_pwd=1;
	this.txtShow = 'Show Password';
	this.txtMask = 'Mask';
	this.txtGenerate = 'Generate Password';
	this.txtWeak='Weak';
...
function _MakePWDWidget()
{
	...
	code += "<div style='text-align: center;' class='pwdopsdiv' id='"+this.pwdshowdiv+"'><a href='#' id='"+this.pwdshow_anch+"'>"+this.txtShow+"</a></div>";

	this.pwdgendiv = pwdname+"_gendiv";

	this.pwdgenerate_anch = pwdname + "_gen_anch";

	code += "<div style='text-align: center;'  class='pwdopsdiv'id='"+this.pwdgendiv+"'><a href='#' id='"+this.pwdgenerate_anch+"'>"+this.txtGenerate+"</a></div>";

	this.pwdstrengthdiv = pwdname + "_strength_div";

	code += "<div style='text-align: center; color: #008000; background-color: yellow;' class='pwdstrength' id='"+this.pwdstrengthdiv+"'>";
