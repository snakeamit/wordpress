  ...
  <div class="container-fluid position-relative p-0 head-nav">
    ...
    <div id="header-carousel" class="slide-header">
      <div class="p-3" style="max-width: 900px; margin: 0 auto;">
        <h4 class="display-3 text-white mb-md-4 animated zoomIn">Spot Rate and Forward Rates - USD/INR </h4>
      </div>
    </div>
  </div>
            ...
            <div class="col-md-12">
              <div class="box">
                ...
                <div class="box-body table-responsive no-padding">
                  ...
                  <td>&#8377; <input id='spotBidPremEUR-" . $d . "' value=" . $row2['bidPremEUR'] . " name='spotBidPremEUR-" . $d . "' type='text' class='numbersonly' style='width:8em; font-size: 16px; color: blue'></td>
                  
                  <td>&#8377; <input id='spotAskPremEUR-" . $d . "' value=" . $row2['askPremEUR'] . " name='spotAskPremEUR-" . $d . "' type='text' class='numbersonly' style='width:8em; font-size: 16px; color: blue'></td>
                  
                  <td>&#8377; <input id='spotBidPremGBP-" . $d . "' value=" . $row2['bidPremGBP'] . " name='spotBidPremGBP-" . $d . "' type='text' class='numbersonly' style='width:8em; font-size: 16px; color: blue'></td>
                  
                  <td>&#8377; <input id='spotAskPremGBP-" . $d . "' value=" . $row2['askPremGBP'] . " name='spotAskPremGBP-" . $d . "' type='text' class='numbersonly' style='width:8em; font-size: 16px; color: blue'></td>
