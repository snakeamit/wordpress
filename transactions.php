...
<head>
  ...
  <title>All Transactions | IBR Live</title>
  ...
  <div class="container-fluid position-relative p-0 head-nav">
    ...
    <div id="header-carousel" class="slide-header">
      <div class="p-3" style="max-width: 900px; margin: 0 auto;">
        <h4 class="display-3 text-white mb-md-4 animated zoomIn">All Transactions</h4>
      </div>
    </div>
  </div>
  <?php //echo $statusMsg; 
    ...
    <div class="col-8">
      ...
      <table class="table table-hover" id="allblogs">
        ...
        while ($row = $result->fetch_assoc()) {
          ...
          } else if ($row['status'] == 'TXN_SUCCESS') {
        ...
        ?>
          ...
          <!-- <td>
                        ...
                        <button class="delbtn btn btn-info btn-sm deleteBlog" data-id="<?php echo $row['id'] ?>"><i class="fa fa-eye" aria-hidden="true"></i> View </button >
                    </td> -->
          ...
          <div class="modal-body">
            ...
            <div class="col-md-8">
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="coupon" id="coupon_code" readonly="readonly" required="required" />
                <br />
                <button id="generate" class="btn btn-success" type="button"><span class="glyphicon glyphicon-random"></span> Generate</button>
              </div>
              <div class="form-group">
                <label>Discount</label>
                <input type="text" class="form-control" name="discount" id="discount" required="required" />
              </div>
              <div class="form-group">
