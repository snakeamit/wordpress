  ...
  <div class="container-fluid position-relative p-0 head-nav">
    ...
    <div id="header-carousel" class="slide-header">
      ...
      <style>
        ...
        .card-carousel .card {
          background: linear-gradient(90deg, rgba(205,254,216,1) 0%, rgba(151,188,253,1) 100%);
    ...
    <div class="container py-5">
      ...
      <div class="row g-5">
        ...
        <div class="col-md-12" style="text-align: center;">
          <h5>Real Time Exchange Rates ( Mid Market Values)</h5>
          <p> Real Time Exchange rates (Mid Market Rates/Interbank Rates/Spot rates)- Mid Market rates are average of buy &amp; sell transactional rates of a currency pair. <br>These rates are just for reference purpose and not for transaction purpose.</p>
        </div>
      </div>
    </div>
  </div>
