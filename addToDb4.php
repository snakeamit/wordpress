<?php
  function addCurrencyRates4($url, $idd) {
    ...
    if($exR){
    $sql = "UPDATE live_ex_rates SET ex_rates='$exR', last_refresh='$date' WHERE id='4'";
  ...
  addCurrencyRates4("https://www.alphavantage.co/query?function=CURRENCY_EXCHANGE_RATE&from_currency=AUD&to_currency=INR&apikey=","4");
?>
