...
<body>
  ...
  <div class="container-fluid shiftb80">
    <div class="row">
      ...
      <div id="d-1" class="col-sm-10 leftNavDefault shiftb80">
              ...
              <div class="panel panel-primary panelBorderColor">
                <div class="panel-body">
                  ...
                  <div class="panel panel-default">
                    <div class="panel-heading">
                      <h5 class="panel-title"> Modify Profile Information </h5>
                    </div>
                    <div class="panel-body">
              ...
              <table class="table table-striped">
                ...
                while ($row2 = $result2->fetch_assoc()) {
                  switch ($row2['product_id']) {
                    case "7":
                      $pname = "Fx-Standard 365";
                      break;

                    case "8":
                      $pname = "Fx-Standard 90";
                      break;

                    case "9":
                      $pname = "Fx-Standard 180";
                      break;

                    case "10":
                      $pname = "Fxpress Gold 90";
                      break;

                    case "11":
                      $pname = "Fxpress Gold 180";
                      break;

                    case "12":
                      $pname = "Fxpress Gold 365";
                      break;
                  ...
                  if ($pname != "" && $row2['status'] != "NOTAVAILABLE")
                    echo "<tr><td>" . $row2['order_id'] . "</td><td>" . $pname . "</td><td>" . date("d-m-Y", strtotime($row2['paid_on'])) . "</td><td>" . date("d-m-Y", strtotime($row2['expire_on'])) . "</td><td>" . $row2['status'] . "</td><td><a href=\"#\" class=\"btn btn-info btn-sm\" download>
                    <span class=\"glyphicon glyphicon-save-file\"></span> Save File </a></td></tr>";
                }
                $conn->close();
                ?>
              </table>
        ...
        <div class="panel panel-primary panelBorderColor">
          ...
          <div class="panel-body">
            ...
            ?>
              <div class="alert alert-success alert-dismissible" role="alert">
                <button type="button" class="close" data-bs-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <strong>Success:</strong> <?php echo $successFeed;
                                          $successFeed = "" ?>
              </div>
            <?php
            } else if ($errorFeed != "") {
            ?>
              <div class="alert alert-danger alert-dismissible" role="alert">
                <button type="button" class="close" data-bs-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                <strong>Error:</strong> <?php echo $errorFeed;
                                        $errorFeed = "" ?>
              </div>
            <?php
            }
          ...
          <div class="modal-content">
            ...
            <form action="" class="form-horizontal" role="form" method="post" name="submitEditRequest">
              ...
              <div class="modal-footer">
                <button type="button" class="btn btn-default pull-left" data-bs-dismiss="modal">Cancel</button>
        ...
        <div class="panel panel-primary panelBorderColor">
          ...
          ?>
            <div class="panel-body">
              ...
              <button style="margin-top: 5px;" type="button" class="btn btn-info" data-bs-toggle="modal" data-bs-target="#addInfo"><i class="fa fa-plus"></i> Add Contract Information</button>
              <button style="margin-top: 5px;" type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#checkAllFwd"><i class="fa fa-list"></i> See All Forward Contracts</button>
              <hr>
              ...
              <p class="text-center" readonly id="viewProfLoss" name="viewProfLoss" style="color: #337ab7; padding: 5px; border-style: double; font-weight: bold; font-size: 16px;" />
              </p>
                ...
                <table class="table table-striped text-center table-bordered bg-info" id="fwdContractTable" style="width: 100%;">
                  ...
                  <tbody>
                    ...
                    ?>
                      ...
                      ?>
                        <script>
                          CalSpotFwdAskSample(<?php echo $currpair; ?>, <?php echo $rw['id']; ?>, <?php echo $splitItCFROM[2]; ?>, <?php echo $splitItCFROM[1]; ?>, <?php echo $splitItCFROM[0]; ?>, <?php echo $rw['amount']; ?>, <?php echo $rw['crate']; ?>);
                        </script>
                        <?php
                      } else {
                        if ($buysell == "2") {
                        ?>
                          <script>
                            CalSpotFwdBidSample(<?php echo $currpair; ?>, <?php echo $rw['id']; ?>, <?php echo $splitItCTO[2]; ?>, <?php echo $splitItCTO[1]; ?>, <?php echo $splitItCTO[0]; ?>, <?php echo $rw['amount']; ?>, <?php echo $rw['crate']; ?>);
                          </script>
                      <?php
                        }
                      }
...
<script>
    ...
    function updateFwdContract(){
        $.post('editFwdContract', {
		  rowid: rid
		}, function(response) {
