<?php
  function addCurrencyRates6($url, $idd) {
    ...
    if($exR){
    $sql = "UPDATE live_ex_rates SET ex_rates='$exR', last_refresh='$date' WHERE id='6'";
  ...
  addCurrencyRates6("https://www.alphavantage.co/query?function=CURRENCY_EXCHANGE_RATE&from_currency=NZD&to_currency=INR&apikey=","6");
?>
