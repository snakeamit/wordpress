<?php
  function addCurrencyRates7($url, $idd) {
    ...
    if($exR){
    $sql = "UPDATE live_ex_rates SET ex_rates='$exR', last_refresh='$date' WHERE id='7'";
  ...
  addCurrencyRates7("https://www.alphavantage.co/query?function=CURRENCY_EXCHANGE_RATE&from_currency=THB&to_currency=INR&apikey=","7");
?>
