<?php
  function addCurrencyRates2($url, $idd) {
    ...
    if($exR){
    $sql = "UPDATE live_ex_rates SET ex_rates='$exR', last_refresh='$date' WHERE id='2'";
  ...
  addCurrencyRates2("https://www.alphavantage.co/query?function=CURRENCY_EXCHANGE_RATE&from_currency=EUR&to_currency=INR&apikey=","2");
?>
