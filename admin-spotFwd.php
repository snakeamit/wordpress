...
$sql="UPDATE spotForward SET fromDate='$fromDate', toDate='$toDate', days='$days', premium='$premium' WHERE id=$i";
...
<head>
  ...
  <title>Spot - Forward | IBR Live</title>
        ...
        <div class="col-md-12">
          <div class="box box-primary">
            <div class="box-header" align=center>
              ...
              <p class="box-title" style="font-size: 22px;"><b>Admin - Forward Rates - Export (Bid)! </p>
            </div>
        ...
        <div class="col-md-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title"><b>Spot Rate and Forward Rates - Export (Bid)</b></h3>
