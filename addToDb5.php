<?php
  function addCurrencyRates5($url, $idd) {
    ...
    if($exR){
    $sql = "UPDATE live_ex_rates SET ex_rates='$exR', last_refresh='$date' WHERE id='5'";
  ...
  addCurrencyRates5("https://www.alphavantage.co/query?function=CURRENCY_EXCHANGE_RATE&from_currency=CAD&to_currency=INR&apikey=","5");
?>
