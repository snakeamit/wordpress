          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="">
                ...
                <p class="text-center" style="font-size: 22px; color: #3378a0;"><b> Looking to pass Certificate Course in Foreign Exchange Examination?</b></p>
                <hr class="divider">  
                ...
                <div class="row justify-content-md-center">
                    ...
                    <div class="col col-lg-5 text-center">
                        <!-- <a href="fe-mock-0200"><button type="button" class="btn btn-labeled btn-lg btn-warning" style="padding: 20px; width: 300px;"><i class="fa fa-angle-double-right"></i> Take 5 Free Mock Tests</button></a>
                        <br/>
                        <a href="our-products"><button type="button" class="btn btn-labeled btn-lg btn-default" style="padding: 20px;  width: 300px;"><i class="fa fa-angle-double-right"></i> Subscribe Now <br/> All Tests in only &#8377; 495/- </button></a>
                        <a href="foreign-exchange-test"><button type="button" class="btn btn-labeled btn-lg btn-success" style="padding: 20px;  width: 300px;"><i class="fa fa-angle-double-right"></i> Already Subscribed? <br/> Start now!</button></a>-->
                ...
                <div class="row justify-content-md-center" style="margin-top: 10px;">
                    ...
                    <div class="col col-lg-12">
                        <p style="font-size: 16px;">As per FEDAI guidelines issued to its member banks, this examination is expected to be passed by each employee working in any area of foreign exchange business of the bank.</p>
